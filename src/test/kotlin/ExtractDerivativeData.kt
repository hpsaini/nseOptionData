...
class ExtractDerivativeData constructor() {
    ...
    private lateinit var marketDirectionVWAP: BigDecimal
    ...
    fun fetchDerivativeData() {
        ...
        do {
            ...
            marketDirectionVWAP = parseJsonData.vWap
        ...
        if ((putDataMap.size != callDataMap.size)) {
            ...
            }while (putDataMap.size != callDataMap.size)
        }
        do {
        ...
        }while (marketCallDirectionDataMap.size!=marketPutDirectionDataMap.size)
